...
// // Fonction pour lister toutes les inscriptions
...
// // Fonction pour récupérer une inscription spécifique
...
//   try {
//     // Créez l'inscription avec la date d'enregistrement
...
//         endDate,
//         amount,
//         dateRegister: new Date(), // Ajout de la date d'enregistrement (date actuelle)
//       },
//     });
...
export const createRegistration = async (req, res) => {
  try {
    const { dateRegister, studentId, amount, moduleId, startDate } = req.body;
    ...
    const newRegistration = await prisma.registration.create({
      data: {
        ...
        amount, // Utilisation du prix du module
